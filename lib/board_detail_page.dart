      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                context.push('/boards/$boardId/stats', extra: boardName),
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              ...
              child: profileAsync.valueOrNull?.avatarUrl == null
                  ? Text(
                      (profileAsync.valueOrNull?.fullName?.isNotEmpty ==
                              true)
                          ? profileAsync.valueOrNull!.fullName![0]
                              .toUpperCase()
                          : '?',
                      style: const TextStyle(
                        fontSize: 13,
          ...
          Padding(
            ...
            child:
                _RealtimeIndicator(isConnected: tasksAsync.hasValue),
          ),
        ],
      ),
      body: Column(
...
class _TaskCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Dismissible(
      ...
      // Siempre retorna false: el optimistic delete quita el widget
      // del stream; Dismissible NO debe animarlo él mismo.
